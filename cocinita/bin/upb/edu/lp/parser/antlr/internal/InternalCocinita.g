...
@after {
	...
	(
		...
		(
			otherlv_25='Vertir'
			{
				newLeafNode(otherlv_25, grammarAccess.getInstruccionAccess().getVertirKeyword_5_0());
			}
			(
				(
					{
						newCompositeNode(grammarAccess.getInstruccionAccess().getBowlBowlParserRuleCall_5_1_0());
					}
					lv_bowl_26_0=ruleBowl
					{
						if ($current==null) {
							$current = createModelElementForParent(grammarAccess.getInstruccionRule());
						}
		...
		(
			otherlv_27='Tamizar'
			{
				newLeafNode(otherlv_27, grammarAccess.getInstruccionAccess().getTamizarKeyword_6_0());
			}
			(
				(
					{
						newCompositeNode(grammarAccess.getInstruccionAccess().getExpExpresionParserRuleCall_6_1_0());
					}
					lv_exp_28_0=ruleExpresion
					{
						if ($current==null) {
							$current = createModelElementForParent(grammarAccess.getInstruccionRule());
						}
			...
			otherlv_29='en'
			{
				newLeafNode(otherlv_29, grammarAccess.getInstruccionAccess().getEnKeyword_6_2());
			}
			otherlv_30='el'
			{
				newLeafNode(otherlv_30, grammarAccess.getInstruccionAccess().getElKeyword_6_3());
			}
			(
				(
					{
						newCompositeNode(grammarAccess.getInstruccionAccess().getBowlBowlParserRuleCall_6_4_0());
					}
